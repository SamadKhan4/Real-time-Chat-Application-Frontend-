...
const Sidebar = ({selectedUser , setSelectedUser}) => {
  ...
  return (
          ...
          <div className='flex justify-between items-center'>
            ...
            <div className="relative py-2 group">
                ...
                <div className='absolute top-full right-0 z-20 w-32 p-5 rounded-md bg-[#282142] border border-gray-600 hidden group-hover:block'>
                    ...
                    <p onClick={() => navigate('/logout')} className="cursor-pointer text-sm">
                        Logout
                    </p>
                </div>
            </div>
    ...
    <div className='bg-[#282142] rounded-full flex items-center gap-2 mt-5 px-4 py-3'>
        ...
        <input type="text" className="bg-transparent border-none outline-none  text-white text-xs placeholder-[#c8c8c8]" placeholder="Search user..." />
    </div>
        </div>
